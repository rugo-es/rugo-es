...
3. Verifica la instalación de Zsh

```sh
zsh --version
```

4. Actualiza el shell por defecto

```sh
chsh -s $(which zsh)
```

5. Cierra el terminal y vuelve a abrir Ubuntu (Deberia abrir zsh por defecto)
...
3. Edita el tema por defecto de Oh My Zsh:

- Abre el fichero de configuración de Zsh
...
2. Abre la configuración de Zsh

```sh
nano ~/.zshrc
```

3. Actualiza la configuración de Zsh para admitir el plugin
...
2. Inserta al final el siguiente contenido
...
3. Busca la siguiente directiva dentro de la configuración del tema y agrega los campos personalizados
...
4. Puedes personalizar la sección del control de versiones, por ejemplo, agregar un emoji (🌿) junto al nombre de la rama

```sh
typeset -g POWERLEVEL9K_VCS_BRANCH_ICON='🌿 '
```

5. También puedes cambiar el icono y el color del prompt de shell
...
6. Guarda el fichero y aplica los cambios
